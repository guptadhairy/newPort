  ...
  return (
    <div>
      ...
      <div className="me">
        ...
        <h1>About Me</h1>
        <p>Hi Im <b>Dhairya Gupta</b> a MERN-Stack Web developer and App Developer with a passion for creating beautiful functional and user-centered digital experiences. With 2 years of experience in the field. I am always looking for new and innovative ways to bring my clients visions to life.</p>
      ...
      <div className="meImage">
          <Image className="meimg" width={300} height={200} src="/dhiru_.jpg" alt="profile" />
        </div>
