  ...
  return (
    ...
    <div className='home1'>
      ...
      <div className='pr_right'>
        ...
        <p className='para'>This is a Temple Website . It was made on React. The functionality of this web-app is that you can browse recorded videos of Aarti online . You can donate online and also you can contact to the pandit ji of the temple</p>
        <div className='show'>
